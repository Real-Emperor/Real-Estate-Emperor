...
export async function POST() {
  try {
    ...
    const building1 = await prisma.property.create({
      data: {
        companyId,
        name: 'Emperor Tower - Building A',
        nameAr: 'الإمبراطور العقاري - المبنى 1',
        nameBn: 'রিয়েল এস্টেট এম্পারর - ভবন ১',
        nameUr: 'ریل اسٹیٹ ایمپیرر - عمارت 1',
        type: 'apartment',
    ...
    const building2 = await prisma.property.create({
      data: {
        companyId,
        name: 'Emperor Tower - Building B',
        nameAr: 'الإمبراطور العقاري - المبنى 2',
        nameBn: 'রিয়েল এস্টেট এম্পারর - ভবন ২',
        nameUr: 'ریل اسٹیٹ ایمپیرر - عمارت 2',
        type: 'apartment',
    ...
    const tenantsData = [
      // ── Emperor Tower - Building A (10 tenants) ──
      ...
      // ── Emperor Tower - Building B (9 tenants) ──
    ...
    const expensesData = [
      ...
      { category: 'maintenance', description: 'AC repair B-108', amount: 380, vendor: 'CoolTech Services', invoiceNumber: 'INV-2010', recurring: false, building: 'Emperor Tower - Building B' },
      { category: 'maintenance', description: 'Elevator maintenance - Emperor Building A', amount: 1800, vendor: 'Schindler Elevators', invoiceNumber: 'INV-2030', recurring: true, building: 'Emperor Tower - Building A' },
      { category: 'maintenance', description: 'Painting - Hallway Emperor Building A', amount: 3200, vendor: 'ColorPro Painters', invoiceNumber: 'INV-2031', recurring: false, building: 'Emperor Tower - Building A' },
      ...
      { category: 'maintenance', description: 'Elevator maintenance - Emperor Building B', amount: 1700, vendor: 'Schindler Elevators', invoiceNumber: 'INV-2034', recurring: true, building: 'Emperor Tower - Building B' },
    ...
    const maintenanceData = [
      ...
      { title: 'Elevator Inspection - Emperor Building A', description: 'Annual elevator inspection and certification renewal due.', category: 'other', vendor: 'Schindler Elevators', priority: 'medium', status: 'pending', estimatedCost: 1500, actualCost: null, propertyId: building1.id },
      ...
      { title: 'Intercom System Repair - Emperor Building B', description: 'Intercom system not working in Emperor Building B. Visitors cannot buzz apartments.', category: 'electrical', vendor: 'SafeWire Electric', priority: 'high', status: 'in-progress', estimatedCost: 1800, actualCost: null, propertyId: building2.id },
      { title: 'Fire Extinguisher Replacement - Emperor Building A', description: 'All fire extinguishers in Emperor Building A need annual replacement.', category: 'other', vendor: 'FirePro Safety', priority: 'medium', status: 'pending', estimatedCost: 900, actualCost: null, propertyId: building1.id },
      ...
      { title: 'Staircase Lighting - Emperor Building B', description: 'Multiple staircase lights not working on floors 3-5.', category: 'electrical', vendor: 'SafeWire Electric', priority: 'medium', status: 'pending', estimatedCost: 400, actualCost: null, propertyId: building2.id },
