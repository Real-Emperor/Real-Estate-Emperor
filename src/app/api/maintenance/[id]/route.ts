...
export async function PUT(
  ...
  const updated = await prisma.maintenance.update({
    ...
    data: {
      ...
      estimatedCost: estimatedCost !== undefined ? (estimatedCost ? parseFloat(estimatedCost) : null) : existing.estimatedCost,
      actualCost: actualCost !== undefined ? (actualCost ? parseFloat(actualCost) : null) : existing.actualCost,
