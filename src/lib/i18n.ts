// Real Estate Emperor - 4-Language i18n System
...
export const translations = {
  ...
  loginSubtitle: { en: 'Real Estate Emperor - Property Management & Investment', ar: 'الإمبراطور العقاري - إدارة الممتلكات والاستثمار', bn: 'রিয়েল এস্টেট এম্পারর - প্রপার্টি ম্যানেজমেন্ট ও ইনভেস্টমেন্ট', ur: 'ریل اسٹیٹ ایمپیرر - پراپرٹی مینجمنٹ اور انویسٹمنٹ' },
  ...
  municipalityFee: { en: 'Municipality Fee', ar: 'رسوم البلدية', bn: 'পৌরসভা ফি', ur: 'بلدیہ فیس' },
  ...
  resetSubject: { en: 'Password Reset Request - Real Estate Emperor Dashboard', ar: 'طلب إعادة تعيين كلمة المرور - لوحة الإمبراطور العقاري', bn: 'পাসওয়ার্ড রিসেট অনুরোধ - রিয়েল এস্টেট এম্পারর ড্যাশবোর্ড', ur: 'پاس ورڈ ری سیٹ کی درخواست - الريف المدینہ ڈیش بورڈ' },
  ...
  propertyCollectionOverview: { en: 'Tenant Collection Overview', ar: 'نظرة عامة على تحصيل المستأجرين', bn: 'ভাড়াটিয়া সংগ্রহ ওভারভিউ', ur: 'کرایہ دار وصولی کا جائزہ' },
  backToProperties: { en: 'Back to Properties', ar: 'العودة إلى العقارات', bn: 'সম্পত্তিতে ফিরুন', ur: 'املاک پر واپس' },
  currentCharges: { en: 'Current Charges', ar: 'الرسوم الحالية', bn: 'বর্তমান চার্জ', ur: 'موجودہ چارجز' },
  creditBalanceLabel: { en: 'Credit Balance', ar: 'رصيد دائن', bn: 'ক্রেডিট ব্যালেন্স', ur: 'کریڈٹ بیلنس' },
  searchTenantOrUnit: { en: 'Search Tenant / Unit', ar: 'بحث المستأجر / الوحدة', bn: 'ভাড়াটিয়া / ইউনিট খুঁজুন', ur: 'کرایہ دار / یونٹ تلاش کریں' },
  viewTenant: { en: 'View Tenant', ar: 'عرض المستأجر', bn: 'ভাড়াটিয়া দেখুন', ur: 'کرایہ دار دیکھیں' },
  viewPaymentHistory: { en: 'Payment History', ar: 'سجل المدفوعات', bn: 'পেমেন্ট ইতিহাস', ur: 'ادائیگی کی تاریخ' },
  viewAdjustments: { en: 'Adjustments', ar: 'التعديلات', bn: 'সমন্বয়', ur: 'ایڈجسٹمنٹس' },
  viewContract: { en: 'View Contract', ar: 'عرض العقد', bn: 'চুক্তি দেখুন', ur: 'معاہدہ دیکھیں' },
  credit: { en: 'Credit', ar: 'ائتمان', bn: 'ক্রেডিট', ur: 'کریڈٹ' },
  recordGroupPayment: { en: 'Record Group Payment', ar: 'تسجيل دفعة المجموعة', bn: 'গ্রুপ পেমেন্ট রেকর্ড করুন', ur: 'گروپ ادائیگی درج کریں' },
  noAdjustmentsFound: { en: 'No adjustments found', ar: 'لم يتم العثور على تعديلات', bn: 'কোনো সমন্বয় পাওয়া যায়নি', ur: 'کوئی ایڈجسٹمنٹ نہیں ملا' },
  ...
  groupReservations: { en: 'Group Reservations', ar: 'تجميع الحجوزات', bn: 'গ্রুপ রিজার্ভেশন', ur: 'گروپ ریزرویشنز' },
  manageGroups: { en: 'Manage Groups', ar: 'إدارة المجموعات', bn: 'গ্রুপ পরিচালনা', ur: 'گروپس کا انتظام' },
  dissolveGroup: { en: 'Dissolve Group', ar: 'حل المجموعة', bn: 'গ্রুপ ভেঙে দিন', ur: 'گروپ ختم کریں' },
  groupAccountName: { en: 'Group Account Name', ar: 'اسم حساب المجموعة', bn: 'গ্রুপ অ্যাকাউন্টের নাম', ur: 'گروپ اکاؤنٹ کا نام' },
  groupAccountNamePlaceholder: { en: 'e.g. Mr. Ahmad Account', ar: 'مثال: حساب السيد أحمد', bn: 'যেমন: মিঃ আহমদ অ্যাকাউন্ট', ur: 'مثلاً: مسٹر احمد اکاؤنٹ' },
  selectUnitsToGroup: { en: 'Select Units to Group', ar: 'اختيار الوحدات للتجميع', bn: 'গ্রুপ করতে ইউনিট নির্বাচন করুন', ur: 'گروپ کرنے کے لیے یونٹس منتخب کریں' },
  unitNumbers: { en: 'Unit Numbers (comma-separated)', ar: 'أرقام الوحدات (مفصولة بفواصل)', bn: 'ইউনিট নম্বর (কমা দিয়ে আলাদা)', ur: 'یونٹ نمبرز (کامے سے الگ)' },
  totalDeposit: { en: 'Total Deposit (split equally)', ar: 'إجمالي التأمين (مقسم بالتساوي)', bn: 'মোট জমা (সমানভাবে ভাগ)', ur: 'کل ڈپازٹ (برابر تقسیم)' },
  perUnitDeposit: { en: 'Per Unit', ar: 'لكل وحدة', bn: 'প্রতি ইউনিট', ur: 'فی یونٹ' },
  linkedToGroup: { en: 'Linked to Group', ar: 'مرتبط بمجموعة', bn: 'গ্রুপের সাথে যুক্ত', ur: 'گروپ سے منسلک' },
  groupMembers: { en: 'Group Members', ar: 'أعضاء المجموعة', bn: 'গ্রুপ সদস্য', ur: 'گروپ ممبران' },
  noGroupsFound: { en: 'No groups found', ar: 'لا توجد مجموعات', bn: 'কোনো গ্রুপ পাওয়া যায়নি', ur: 'کوئی گروپ نہیں ملا' },
  createNewGroup: { en: 'Create New Group', ar: 'إنشاء مجموعة جديدة', bn: 'নতুন গ্রুপ তৈরি করুন', ur: 'نیا گروپ بنائیں' },
  linkToExistingGroup: { en: 'Link to Existing Group', ar: 'ربط بمجموعة موجودة', bn: 'বিদ্যমান গ্রুপে যুক্ত করুন', ur: 'موجودہ گروپ سے منسلک کریں' },
  selectGroup: { en: 'Select Group', ar: 'اختيار المجموعة', bn: 'গ্রুপ নির্বাচন করুন', ur: 'گروپ منتخب کریں' },
  removeFromGroup: { en: 'Remove from Group', ar: 'إزالة من المجموعة', bn: 'গ্রুপ থেকে সরান', ur: 'گروپ سے ہٹائیں' },
  confirmDissolveGroup: { en: 'Are you sure you want to dissolve this group? Units will remain as standalone records.', ar: 'هل أنت متأكد من حل هذه المجموعة؟ ستبقى الوحدات كسجلات مستقلة.', bn: 'আপনি কি এই গ্রুপ ভাঙতে চান? ইউনিটগুলি স্বাধীন রেকর্ড হিসাবে থাকবে।', ur: 'کیا آپ واقعی اس گروپ کو ختم کرنا چاہتے ہیں؟ یونٹس آزاد ریکارڈ کے طور پر رہیں گے۔' },
  groupCreatedSuccess: { en: 'Group created successfully', ar: 'تم إنشاء المجموعة بنجاح', bn: 'গ্রুপ সফলভাবে তৈরি হয়েছে', ur: 'گروپ کامیابی سے بنا' },
  selectAtLeastTwoUnits: { en: 'Please select at least 2 units to form a group', ar: 'يرجى اختيار وحدتين على الأقل لتشكيل مجموعة', bn: 'গ্রুপ করতে অন্তত ২টি ইউনিট নির্বাচন করুন', ur: 'گروپ بنانے کے لیے کم از کم 2 یونٹس منتخب کریں' },
  perUnitRent: { en: 'Per-unit Rent', ar: 'الإيجار لكل وحدة', bn: 'প্রতি ইউনিট ভাড়া', ur: 'فی یونٹ کرایہ' },
