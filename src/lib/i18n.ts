...
export const translations = {
  ...
  loginSubtitle: { en: 'Real Estate Emperor Property Management L.L.C.', ar: 'إمبراطور العقارات لإدارة الممتلكات ذ.م.م', bn: 'রিয়েল এস্টেট এম্পেরর প্রপার্টি ম্যানেজমেন্ট এলএলসি', ur: 'رییل اسٹیٹ ایمپیرر پراپرٹی مینجمنٹ ایل ایل سی' },
  ...
  resetSubject: { en: 'Password Reset Request - Real Estate Emperor Dashboard', ar: 'طلب إعادة تعيين كلمة المرور - لوحة إمبراطور العقارات', bn: 'পাসওয়ার্ড রিসেট অনুরোধ - রিয়েল এস্টেট এম্পেরর ড্যাশবোর্ড', ur: 'پاس ورڈ ری سیٹ کی درخواست - رییل اسٹیٹ ایمپیرر ڈیش بورڈ' },
  ...
  completedBackup: { en: 'Completed', ar: 'مكتمل', bn: 'সম্পন্ন', ur: 'مکمل' },
  ...
  addBill: { en: 'Add Bill', ar: 'إضافة فاتورة', bn: 'বিল যোগ করুন', ur: 'بل شامل کریں' },
  editBill: { en: 'Edit Bill', ar: 'تعديل الفاتورة', bn: 'বিল সম্পাদনা', ur: 'بل میں ترمیم' },
  ...
  monthlyExpected: { en: 'Monthly Expected (AED)', ar: 'المتوقع شهرياً (درهم)', bn: 'মাসিক প্রত্যাশিত (দিরহাম)', ur: 'ماہانہ متوقع (درہم)' },
  outstandingBalance: { en: 'Outstanding Balance', ar: 'الرصيد المستحق', bn: 'বকেয় ব্যালেন্স', ur: 'واجب الادا بیلنس' },
  billLastPayment: { en: 'Last Payment', ar: 'آخر دفعة', bn: 'সর্বশেষ পেমেন্ট', ur: 'آخری ادائیگی' },
  nextDue: { en: 'Next Due', ar: 'الاستحقاق القادم', bn: 'পরবর্তী বকেয়', ur: 'اگلی ادائیگی' },
  billingFrequency: { en: 'Billing Frequency', ar: 'تكرار الفوترة', bn: 'বিলিং ফ্রিকোয়েন্সি', ur: 'بلنگ کی فریکوئنسی' },
  autoRenew: { en: 'Auto Renew', ar: 'تجديد تلقائي', bn: 'স্বয়ংক্রিয় নবায়ন', ur: 'خودکار تجدید' },
  gracePeriod: { en: 'Grace Period (Days)', ar: 'فترة السماح (أيام)', bn: 'গ্রেস পিরিয়ড (দিন)', ur: 'مہلت کی مدت (دن)' },
  internalNotes: { en: 'Internal Notes', ar: 'ملاحظات داخلية', bn: 'অভ্যন্তরীণ নোট', ur: 'داخلی نوٹ' },
  billRecordPayment: { en: 'Record Payment', ar: 'تسجيل دفعة', bn: 'পেমেন্ট রেকর্ড করুন', ur: 'ادائیگی درج کریں' },
  billDetails: { en: 'Bill Details', ar: 'تفاصيل الفاتورة', bn: 'বিলের বিবরণ', ur: 'بل کی تفصیلات' },
  billPaymentHistory: { en: 'Payment History', ar: 'سجل المدفوعات', bn: 'পেমেন্ট ইতিহাস', ur: 'ادائیگی کا ریکارڈ' },
  ...
  totalBills: { en: 'Total Bills', ar: 'إجمالي الفواتير', bn: 'মোট বিল', ur: 'کل بلز' },
  paidThisMonth: { en: 'Paid This Month', ar: 'مدفوع هذا الشهر', bn: 'এই মাসে পরিশোধিত', ur: 'اس مہینے ادا شدہ' },
  overdueCount: { en: 'Overdue', ar: 'متأخرة', bn: 'বকেয়া', ur: 'تاخیری' },
  searchBills: { en: 'Search Bills, Providers, Properties...', ar: 'بحث الفواتير، المزودين، العقارات...', bn: 'বিল, সরবরাহকারী, সম্পত্তি খুঁজুন...', ur: 'بلز، فراہم کنندگان، املاک تلاش کریں...' },
  ...
  // Payment Edit/Delete & Cycle-specific i18n (12 new keys)
  allPayments: { en: 'All Payments', ar: 'جميع المدفوعات', bn: 'সমস্ত পেমেন্ট', ur: 'تمام ادائیگیاں' },
  ...
  deletePaymentConfirm: { en: 'Are you sure you want to delete this payment? This will recalculate the billing cycle balance.', ar: 'هل أنت متأكد من حذف هذه الدفعة؟ سيتم إعادة حساب رصيد دورة الفوترة.', bn: 'আপনি কি নিশ্চিত যে আপনি এই পেমেন্টটি মুছে ফেলতে চান? এটি বিলিং সাইকেলের ব্যালেন্স পুনরায় গণনা করবে।', ur: 'کیا آپ یقینی طور پر اس ادائیگی کو حذف کرنا چاہتے ہیں؟ یہ بلنگ سائیکل کے بیلنس کو دوبارہ حساب کرے گا۔' },
  paymentUpdated: { en: 'Payment updated successfully', ar: 'تم تحديث الدفعة بنجاح', bn: 'পেমেন্ট সফলভাবে আপডেট হয়েছে', ur: 'ادائیگی کامیابی سے اپ ڈیٹ ہو گئی' },
  paymentDeleted: { en: 'Payment deleted successfully', ar: 'تم حذف الدفعة بنجاح', bn: 'পেমেন্ট সফলভাবে মুছে ফেলা হয়েছে', ur: 'ادائیگی کامیابی سے حذف ہو گئی' },
  amountDue: { en: 'Amount Due', ar: 'المبلغ المستحق', bn: 'বকেয় পরিমাণ', ur: 'واجب الادا رقم' },
  ...
  noPaymentsYet: { en: 'No payments recorded yet', ar: 'لم يتم تسجيل مدفوعات بعد', bn: 'এখনো কোনো পেমেন্ট রেকর্ড হয়নি', ur: 'ابھی تک کوئی ادائیگی درج نہیں ہوئی' },
  paymentAmount: { en: 'Payment Amount', ar: 'مبلغ الدفعة', bn: 'পেমেন্টের পরিমাণ', ur: 'ادائیگی کی رقم' },
  referenceNumber: { en: 'Reference Number', ar: 'رقم المرجع', bn: 'রেফারেন্স নম্বর', ur: 'حوالہ نمبر' },
} as const
