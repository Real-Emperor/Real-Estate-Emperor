...
export const translations = {
  ...
  forgotPasswordDesc: { en: 'Enter your email address and we will send a reset request to the system administrator. You will receive new credentials via email.', ar: 'أدخل بريدك الإلكتروني وسنرسل طلب إعادة تعيين إلى مسؤول النظام. ستتلقى بيانات اعتماد جديدة عبر البريد الإلكتروني.', bn: 'আপনার ইমেইল ঠিকানা লিখুন এবং আমরা সিস্টেম প্রশাসকের কাছে একটি রিসেট অনুরোধ পাঠাব। আপনি ইমেইলের মাধ্যমে নতুন পরিচয়পত্র পাবেন।', ur: 'اپنا ای میل ایڈریس درج کریں اور ہم سسٹم ایڈمن کو ری سیٹ کی درخواست بھیجیں گے۔ آپ کو ای میل کے ذریعے نئی اسناد ملیں گی۔' },
